...
def getscheduler(args, optimizer, last_epoch=-1):
    ...
    if args.scheduler == 'MultiStepLR':
        ...
        return torch.optim.lr_scheduler.StepLR(optimizer, args.warm_up_epochs, gamma=args.decreasing_lr, last_epoch=last_epoch)
    
    elif args.scheduler == 'Cosine':
        return torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=args.warm_up_epochs, eta_min=args.learning_rate*args.decreasing_lr, last_epoch=last_epoch)
