...
class StandardExcuter(object):
    def __init__(self, 
        ...
        self.args = args
        self.model = model(KGE=KGE, embedding_manager=embedding_manager, entity_pruner=entity_pruner, relation_pruner=relation_pruner, loss=loss, kdloss=kdloss, args=args)
    ...
    def Run(self):
        ...
        for epoch in range(self.args.epoch):
            ...
            if (epoch+1)%(self.args.test_per_epochs+1)==0:
                metric = self.test_model()
