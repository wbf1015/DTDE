...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if choice == 1:
            negative_sample = self.query_negative_sample(head, relation, tail, self.args.pre_sample_size)
        elif choice == 2:
            negative_sample = self.relation_negative_sample(head, relation, tail, self.args.pre_sample_size)
        elif choice == 3:
            negative_sample = self.random_negative_sample(head, relation, tail)
    ...
    def relation_negative_sample(self, head, relation, tail, pre_sample_num):
        def pre_sampling(head, relation, tail, pre_sample_num):
        ...
        pre_sample_list = pre_sampling(head, relation, tail, pre_sample_num=pre_sample_num)
    ...
    def query_negative_sample(self, head, relation, tail, presample_num):
        def pre_sampling(head, relation, tail, pre_sample_num):
        ...
        pre_sample_list = pre_sampling(head, relation, tail, pre_sample_num=presample_num)
        negative_sample_list = [pre_sample_list]
        negative_sample_size = len(pre_sample_list)
    ...
    def random_negative_sample(self, head, relation, tail):
