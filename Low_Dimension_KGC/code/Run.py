...
# from EmbeddingManager.KDManager_Reverse_2KGEv3 import *
...
# from Decoder.Sim_decoder.Sim_decoder import *
...
#     TrainDataset_Random(train_triples, nentity, nrelation, args.negative_sample_size, args=args), 
#     batch_size=args.batch_size,
#     shuffle=True, 
#     num_workers=max(1, args.cpu_num//2),
#     collate_fn=TrainDataset_Random.collate_fn
# )
...
# KGE1 = SCCF_Reverse(args, teacher_embedding_dim=256, teacher_temp=0.5, pretrain_path=args.pretrain_path)
KGE1 = RotatE_Reverse(teacher_margin=2.0, teacher_embedding_dim=256) # 直接训练的RotatE
# KGE1 = AttH_Reverse(args)

# KGE2 = SCCF_Reverse(args, teacher_embedding_dim=256, teacher_temp=1.0, pretrain_path=args.pretrain_path2)
