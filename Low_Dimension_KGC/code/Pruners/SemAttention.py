...
from Transformer.PoswiseFeedForwardNet import *
from Transformer.ScaleDotAttention import *
from Transformer.SelfAttention import *
...
class SemAttention8(nn.Module):
    def __init__(self, args):
        ...
        self.args = args
        self.layer1 = LGSemAttention(2000, 256, args.token1, args.head1, d_ff=args.t_dff)
        self.layer2 = SemUpdate(256, 2000)
        self.layer3 = LowDimGenerate(256, 2000, 64, args.t_dff)
